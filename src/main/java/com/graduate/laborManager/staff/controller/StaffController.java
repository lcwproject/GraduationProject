...
public class StaffController {
    ...
    public ModelAndView checkStaff(@RequestParam(value = "name") String name, @RequestParam(value = "password") String password){
        Staff staff = new Staff();
        ...
        try {
            ...
            modelAndView.addObject("currentStaff",staff);
        } catch (Exception e) {
            e.printStackTrace();
